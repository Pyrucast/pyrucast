...
class ElementField:
    ...
    """
    def __new__(cls, fespace: SubFESpace, components: typing.Sequence[builtins.str]) -> ElementField:
        r"""
        `ElementField(subfespace, components)` — zero-initialized field.
        """
    @classmethod
    def from_uniform_per_component(cls, fespace: SubFESpace, components: typing.Sequence[builtins.str], values_per_component: typing.Sequence[builtins.float]) -> ElementField:
        r"""
    ...
    def __add__(self, rhs: builtins.float) -> ElementField: ...
    def __sub__(self, rhs: builtins.float) -> ElementField: ...
    def __mul__(self, rhs: builtins.float) -> ElementField: ...
    def __truediv__(self, rhs: builtins.float) -> ElementField: ...
