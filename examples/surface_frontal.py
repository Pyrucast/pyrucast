"""Frontal quadrangle mesher demo (`pyrucast.mesh.pave_surface`).
...
def main() -> None:
    ...
    contour = pc.mesh.circle(center, [0.0, 0.0, 1.0], 5.0, 48)

    # Quadrangles of edge length ~0.8; a few triangles may remain.
    quad = pc.mesh.pave_surface(contour, "QUA4", 0.8)
    ...
    strict = pc.mesh.pave_surface(contour, "QUA4", 0.8, all_quad=True)
    ...
    recombined = pc.mesh.triangulate_surface(contour, "QUA4", 0.8)
