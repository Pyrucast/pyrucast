...
FR — Deux familles de mailleurs sont comparées :
...
EN — Two families of meshers are compared:
...
# FR — Points guides, les points p1/p2/p4/p5 sont les coins du
...
# EN — Guide points, the points p1/p2/p4/p5 are the rectangle's
...
def border_plate_with_hole() -> pc.Mesh:
    ...
    # sans toucher à la connectivité.
...
def structured_mesh() -> tuple[pc.Mesh, pc.Mesh]:
    ...
    # le moyen d'obtenir un maillage structuré propre autour d'un trou.
    # EN — `sweep` links both loops with 3 layers of QUA4:
    # the way to get a clean structured mesh around a hole.
