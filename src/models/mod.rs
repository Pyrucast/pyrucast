...
//!
//! Each file here owns the **specifics** of one [`crate::containers::model::Physics`]
...
//! [`crate::containers::matrix::Matrix`]. The [`crate::containers::model::SubModel`] type
//! dispatches into these modules so that each physics's code lives in
//! one self-contained place.
//!
//! Adding a new physics means: extend [`crate::containers::model::Physics`] with a
