...
pub use crate::models::plastic::drucker_prager::drucker_prager;
pub use crate::models::plastic::gurson::gurson;
pub use crate::models::plastic::ottosen::ottosen;
pub use crate::models::plastic::viscous::creep_blackburn;
pub use crate::models::plastic::viscous::creep_lemaitre;
pub use crate::models::plastic::viscous::creep_norton;
pub use crate::models::plastic::viscous::viscoplasticity_chaboche;
pub use crate::models::plastic::viscous::viscoplasticity_lemaitre_chaboche;
pub use crate::models::plastic::von_mises::plasticity_isotropic;
pub use crate::models::plastic::von_mises::plasticity_perfect;
...
pub use damage::damage_with_law;
...
pub use mpc::mpc;
pub use plasticity::plasticity_with_law;
