...
/// coupling into `target`, the model assembling the transferred pairs and
/// giving the interface its nature. Parent-level operator; the coefficients
/// `h_<primal>` are supplied at assembly time.
///
