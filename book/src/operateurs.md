...
|---|---|---|
| `ops::mesher` | [Maillage](operateurs/maillage.md) | `line`, `circle`, `arc`, `extrude`, `sweep`, `transfinite` (DALL), `sweep_solid`, `translate`, `rotate`, `triangulate_surface`, `volume`, `mesh_volume`, `border`, `skin`, `orient`, `invert`, `elements_on`, `merge_nodes`, `read_gmsh`, `to_poi1`, `to_quadratic`, `convert`, `barycenter`, `consolidate`… |
