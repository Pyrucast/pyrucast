...
d'arête seulement) ; `SEG3`, `TRI6`, `TET10` et `QUA9` sont des Lagrange
complets (`QUA9` = quadrangle biquadratique avec nœud central). Ils se posent
avec l'interpolation `LAGRANGE2` (cf. [Espace éléments finis](fe-space.md)).
